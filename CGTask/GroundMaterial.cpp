...
void GroundMaterial::initialize()
{

	std::string vertFilename = "../shaders/CGTask/ground.vert";
	std::string fragFilename = "../shaders/CGTask/ground.frag";
...
void GroundMaterial::applyCommonUniforms()
{
...
void GroundMaterial::applyModelSpecificUniforms()
{
