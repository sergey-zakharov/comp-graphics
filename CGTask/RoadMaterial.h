...
/**
“иповой шейдер. ѕримен€етс€ дл€ обычных 3д-моделей. –еализует освещение и текстурирование. »нкапсулирует работу с шейдерами: создание шейдера, хранение uniform-переменных
*/
...
protected:
	...
	//====== переменные, которые содержат значени€, которые будут записаны в uniform-переменные шейдеров ======
	float _time;
